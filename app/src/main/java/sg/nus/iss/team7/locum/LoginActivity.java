...
public class LoginActivity extends AppCompatActivity {
                                            ...
                                            //depends on phone S20 requires manual setting of permissions
                                                ...
                                                builder.setMessage(
                                                                "The \"show notification\" is a normal permission so there is no need to request for permission at runtime, " +
                                                                        "Android will automatically request for runtime permission when creating notifications. In " +
                                                                        "some cases, the first push notification will not be displayed when using Android's permission prompt." +
    ...
    // Confirmation prompt for exiting app
    @Override
    ...
    // Hide soft keyboard on element loses focus
    @Override
